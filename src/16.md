...
<img src="iconos/dana.png" >
<figcaption>Fuente: <a href="https://josemamira.github.io/curso_maplibre/src/15bis.html">Elaboración propia</a><br>
...
### Datos
Para este ejemplo voy a utilizar una archivo GeoJSON que he realizado uniendo los observatorios de AVAMET disponibles en el portal de la IDEV, y los datos climáticos obtenidos de esta [página](https://www.avamet.org/mx-meteoxarxa.php?id=2024-10-29) del propio portal AVAMET del fatídico día **29 de octubre de 2024**, done una **DANA** entró en la provincia de Valencia, afectando principalmente a los municipios de la comarca de la Horta Sur. A partir de la página web y tras múltiples procesos conseguí obtener una tabla con la que unir (join) los datos con los puntos de los observatorios.
